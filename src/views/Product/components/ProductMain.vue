<template>
    <div class="container">
            ...
            <div class="col-md-6 col-sm-12 mb-4">
                <img src="https://placehold.co/640x420" class="img-fluid portrait-image" alt="">
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="row">
                    <div class="col-md-6 col-6 mb-4">
                        <img src="https://placehold.co/310x200" class="img-fluid" alt="">
                    </div>
                    <div class="col-md-6 col-6 mb-4">
                        <img src="https://placehold.co/310x200" class="img-fluid" alt="">
                    </div>
...
.ui-bookmark {
    ...
    --icon-hover-color: rgb(196, 196, 196);
