$(document).ready(function () {
  ...
  var n = 100,
    ...
    c = function () {
      ...
      var e = function () {
          a.hasClass("page-sidebar-fixed") && i === !1 && (i = !0),
            i === !0 &&
              (a.addClass("page-sidebar-fixed"),
              $("#fixed-sidebar-toggle-button").removeClass(
                "icon-radio_button_unchecked"
              ),
              $("#fixed-sidebar-toggle-button").addClass(
                "icon-radio_button_checked"
              ));
          var e = function () {
            a.toggleClass("page-sidebar-fixed"),
              (i = a.hasClass("page-sidebar-fixed") ? !0 : !1);
          };
        ...
        n = function () {
          ...
          var e = function () {
            a.toggleClass("page-sidebar-collapsed"),
              (l = a.hasClass("page-sidebar-collapsed") ? !0 : !1),
      ...
      e.hide(),
        ...
        $(".accordion-menu").on("click", "a", function () {
          var e = $(this).next(".sub-menu"),
            ...
            c = function () {
              $(".accordion-menu > li.open > .sub-menu").slideUp(n),
                i.removeClass("open");
            };
          return e.length && !a.hasClass("page-sidebar-collapsed")
            ? (s.hasClass("open") ? o() : (i.length && c(), l()), !1)
            : e.length && a.hasClass("page-sidebar-collapsed")
            ? !1
            : void 0;
        }),
      ...
      $("#toggle-fullscreen").on("click", function () {
        ...
        $("#search-button").on("click", function () {
          a.toggleClass("search-open"),
            a.hasClass("search-open") && $(".search-form input").focus();
        }),
